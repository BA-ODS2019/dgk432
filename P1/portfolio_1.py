...
print('\n\nFakta om rejsende pr. klasse vises som Pivot tabel: ')
pt = titanic.pivot_table(columns = 'Pclass') # inkl hvor meget de har betalt, deres alder, søskende mv.
print(pt)
pt.plot(kind='bar')
plt.title("fakta om rejsende pr. klasse")
plt.savefig("TravellersPrClass.png")
